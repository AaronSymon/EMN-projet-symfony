...
class Participant implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function addSortiesOrganisee(Sortie $sortiesOrganisee): self
    {
        if (!$this->sortiesOrganisees->contains($sortiesOrganisee)) {
            ...
            $sortiesOrganisee->setParticipant($this);
        }
    ...
    public function removeSortiesOrganisee(Sortie $sortiesOrganisee): self
    {
        if ($this->sortiesOrganisees->removeElement($sortiesOrganisee)) {
            ...
            if ($sortiesOrganisee->getParticipant() === $this) {
                $sortiesOrganisee->setParticipant(null);
            }
        }
    ...
    public function getSiteRatache(): ?Site
    {
        return $this->siteRatache;
    }

    public function setSiteRatache(?Site $siteRatache): self
    {
        $this->siteRatache = $siteRatache;
